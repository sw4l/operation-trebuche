...
_elev = elev;
_vehicle = "OPTRE_M12_FAV"  createVehicle getPos _elev; _vehicle setPos [getPos _vehicle select 0, getPos _vehicle select 1, 0];
_vehicle enablesimulation false;
_vehicle allowdamage false;
_vehicle attachTo [elev, [0, -.3, -21.4] ]; 
_vehicle setVectorDirAndUp [[0,0.60,-0.15],[0,0.15,0.60]];
