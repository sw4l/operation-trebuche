_getHelmet_preprocess = preprocessFileLineNumbers "\TEI_Core\scripts\HUD\fn_getHelmet.sqf";
_setHelmet_preprocess = preprocessFileLineNumbers "\TEI_Core\scripts\HUD\fn_setHelmet.sqf";
_LowLightToggle_preprocess = preprocessFileLineNumbers "\TEI_Core\scripts\HUD\fn_LowLightToggle.sqf";
_VisorToggle_preprocess = preprocessFileLineNumbers "\TEI_Core\scripts\HUD\fn_VisorToggle.sqf";
