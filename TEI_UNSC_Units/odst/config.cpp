...
class cfgWeapons
{
	...
	{	
		...
		hiddenSelections[]   																	= {"camo1","camo2","attach_communication","attach_flashlight","attach_rangefinder","attach_rebreather"}; /// what selection in model could have different textures
