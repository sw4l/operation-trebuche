...
class OPTRE_HUD_CoustomiseODST
{
    ...
    class Controls
    {
		...
		////////////////////////////////////////////////////////
		class MainSystemMenu : OPTRE_HUD_RscListbox
		{
			idc = 1500;
