class CfgPatches
{
	...
	{
		units[] = {"OPTRE_Objects_Wreck_Hornet"};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgVehicles
{
	...
	class OPTRE_Hornet_base: Helicopter_Base_H
	{
		...
		displayName = "Hornet"; 								/// how is the heli displayed in editor
		model = "\OPTRE_vehicles\hornet\hornet.p3d"; 	/// path to model of the heli
		...
		//driverAction = pilot_vtol01_armed;				/// what is the standard pose for the pilot, defined as animation state
		//driverInAction = pilot_vtol01_armed;				/// what is the standard pose for the pilot, defined as animation state
		...
		cargoProxyIndexes[] = {};		/// what indexes does regular cargo sit on
		...
		weapons[] = {"OPTRE_GUA23A",  "OPTRE_missiles_C2GMLS",  "CMFlareLauncher"};	/// array of various vehicle weapons mounted on the heli
		magazines[] = {"OPTRE_2000Rnd_20mm_HEIAP", "OPTRE_12Rnd_C2GMLS_missiles","168Rnd_CMFlare_Chaff_Magazine"}; /// array of corresponding magazines
		...
		class Turrets: Turrets										/// just a copilot seat as a turret to enable taking the controls
		{
			class CargoTurret_01: CargoTurret 						/// position for Firing from Vehicles
			{
				...
				gunnerName 					= "Passenger R";	/// name of the position in the Action menu
			...
			class CargoTurret_02: CargoTurret_01						/// position for Firing from Vehicles
			{
				...
				gunnerName 					= "Passenger L";	/// name of the position in the Action menu
		...
		class AnimationSources: AnimationSources	/// custom made animation sources
		{
			class Gatling_flash
			{
				...
				weapon = "OPTRE_GUA23A";	/// this is the said weapon
			};
			class Muzzle_flash
			{
				source="ammorandom";
	...
	class OPTRE_UNSC_hornet_green_CAP: OPTRE_hornet_base
	{
		...
		displayName = "AV-14 Hornet (Green) [CAP]";
	...
	class OPTRE_UNSC_hornet_desert_CAP: OPTRE_UNSC_hornet_green_CAP
	{
		author="Article 2 Studios";
		displayName = "AV-14 Hornet (Desert) [CAP]";
		hiddenSelections[]= {"camo1","clan","clan_text","insignia"}; //Determines what hiddenselections are enabled
		hiddenSelectionsTextures[]= {"optre_vehicles\hornet\data\hornet_hull_desert_co.paa"};
	};
	class OPTRE_UNSC_hornet_black_CAP: OPTRE_UNSC_hornet_green_CAP
	{
		author="Article 2 Studios";
		displayName = "AV-14 Hornet (Black) [CAP]";
		hiddenSelections[]= {"camo1","clan","clan_text","insignia"}; //Determines what hiddenselections are enabled
		hiddenSelectionsTextures[]= {"optre_vehicles\hornet\data\hornet_hull_black_co.paa"};
	};
	class OPTRE_UNSC_hornet_snow_CAP: OPTRE_UNSC_hornet_green_CAP
	{
		author="Article 2 Studios";
		displayName = "AV-14 Hornet (Snow) [CAP]";
		hiddenSelections[]= {"camo1","clan","clan_text","insignia"}; //Determines what hiddenselections are enabled
		hiddenSelectionsTextures[]= {"optre_vehicles\hornet\data\hornet_hull_snow_co.paa"};
	};
	class OPTRE_UNSC_hornet_ins_CAP: OPTRE_UNSC_hornet_green_CAP
	{
	...
	class OPTRE_UNSC_hornet_green_CAS: OPTRE_UNSC_hornet_green_CAP
	{
		author="Article 2 Studios";
		displayName = "AV-14 Hornet (Green) [CAS]";
		weapons[] = {"OPTRE_GUA23A",  "OPTRE_missiles_Anvil1",  "CMFlareLauncher"};	/// array of various vehicle weapons mounted on the heli
		magazines[] = {"OPTRE_2000Rnd_20mm_HEIAP", "OPTRE_32Rnd_Anvil1_missiles","168Rnd_CMFlare_Chaff_Magazine"}; /// array of corresponding magazines
	};
	class OPTRE_UNSC_hornet_desert_CAS: OPTRE_UNSC_hornet_green_CAS
	{
		author="Article 2 Studios";
		displayName = "AV-14 Hornet (Desert) [CAS]";
		hiddenSelections[]= {"camo1","clan","clan_text","insignia"}; //Determines what hiddenselections are enabled
		hiddenSelectionsTextures[]= {"optre_vehicles\hornet\data\hornet_hull_desert_co.paa"};
	};
	class OPTRE_UNSC_hornet_black_CAS: OPTRE_UNSC_hornet_green_CAS
	{
		author="Article 2 Studios";
		displayName = "AV-14 Hornet (Black) [CAS]";
		hiddenSelections[]= {"camo1","clan","clan_text","insignia"}; //Determines what hiddenselections are enabled
		hiddenSelectionsTextures[]= {"optre_vehicles\hornet\data\hornet_hull_black_co.paa"};
	};
	class OPTRE_UNSC_hornet_snow_CAS: OPTRE_UNSC_hornet_green_CAS
	{
		author="Article 2 Studios";
		displayName = "AV-14 Hornet (Snow) [CAS]";
		hiddenSelections[]= {"camo1","clan","clan_text","insignia"}; //Determines what hiddenselections are enabled
		hiddenSelectionsTextures[]= {"optre_vehicles\hornet\data\hornet_hull_snow_co.paa"};
	};
	class OPTRE_UNSC_hornet_ins_CAS: OPTRE_UNSC_hornet_green_CAS
	{
		faction	= "OPTRE_Ins";			/// defines the faction inside of the side
		crew = "OPTRE_Ins_ER_Rebel_tan";	/// lets use the sample soldier we have as default captain of the boat
		vehicleClass = "OPTRE_Ins_Air_class";
