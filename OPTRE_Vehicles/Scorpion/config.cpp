class CfgPatches
{
	...
	{
		units[]={"OPTRE_Scorpion_base","OPTRE_UNSC_Scorpion_base","OPTRE_UNSC_Scorpion"};
		weapons[]={};
		requiredVersion=0.1;
...
class CfgVehicles {
			...
			class MainTurret: MainTurret {
				class Turrets: Turrets {
					class CommanderOptics: CommanderOptics {
						...
						gunBeg = "gun_muzzle";
						gunEnd = "gun_chamber";
						weapons[] = { HMG_127 , SmokeLauncher};	// you may need different weapon class to provide firing effects emit from proper position.
	...
	/*	Faction variants	*/
	class OPTRE_UNSC_Scorpion_base: OPTRE_Scorpion_base 
	{
		...
		crew = "OPTRE_UNSC_Army_W_Crewman";
		typicalCargo[] = {"OPTRE_UNSC_Army_W_Crewman"};
	};
	...
	class OPTRE_UNSC_Scorpion: OPTRE_UNSC_Scorpion_base 
	{
		...
		displayName = "M808 Scorpion";	// due to above will show only in editor
	};
