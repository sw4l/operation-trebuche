...
OPTRE_HUD_Color = "OPTRE_ODST_HUD_blue"; //Values are OPTRE_ODST_HUD_blue / OPTRE_ODST_HUD_orange / OPTRE_ODST_HUD_white / OPTRE_ODST_HUD_green / OPTRE_ODST_HUD_purple
