...
class CfgWeapons 
{
	...
	class TEI_M41_SSR : launch_NLAW_F
	{
		scope = 2;
		...
		handAnim[]={"OFP2_ManSkeleton","\TEI_Weapons\Rockets\Data\Anim\SMAW.rtm"};
	...
	/*class TEI_M41_SAR: launch_Titan_base
	{
		scope = 2;
		author = "The Eridanus Insurrection Team";
		displayname = "M41 SAR MAV/AW";
		descriptionshort = "Surface-to-Air Rocket Medium Anti-Vehicle/Assault Weapon";
		
		class Library 
		{
			libtextdesc = "The M41 Surface-to-Air Rocket Medium Anti-Vehicle/Assault Weapon formally known as the Medium Anti-Vehicle / Assault Weapon, Bore 102mm, M41 Surface-to-Air Rocket Launcher, is a heavy ordnance weapon of the UNSC arsenal";
		};
		magazines[] = {"TEI_M41_HEDP","TEI_M41_HEAA","TEI_M41_Twin_HEAA"};
		picture = "";
		model = "\TEI_Weapons\Rockets\M41_launcher.p3d";
		handAnim[]={"OFP2_ManSkeleton","\TEI_Weapons\Rockets\Data\Anim\SMAW.rtm"};
		drysound[] = {"A3\sounds_f\weapons\other\dry6", 0.0316228, 1, 10};
